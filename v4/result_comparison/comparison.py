...
ABSOLUTE_PATH = os.environ.get('MICRO_AEVOL_PROJECT_DIRECTORY') + "/v4/result_comparison"
...
def main():
    ...
    print("V4 GPU compiled and copied to experiment_to_challenge")
    ...
    print("V4 GPU executed and fitness result written in ./experiment_to_challenge/result_fitness_gpu.csv")
