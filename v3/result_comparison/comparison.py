...
ABSOLUTE_PATH = os.environ.get('MICRO_AEVOL_PROJECT_DIRECTORY') + "/v3/result_comparison"
...
def main():
    ...
    print("V3 GPU compiled and copied to experiment_to_challenge")
    ...
    print("V3 GPU executed and fitness result written in ./experiment_to_challenge/result_fitness_gpu.csv")
